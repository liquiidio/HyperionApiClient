...
namespace EosRio.HyperionApi.Tests
{
    ...
    public class ChainClientTests
    {
        ...
        [TestMethod()]
        public async Task GetAbiGetAsyncTest()
        {
        ...
        [TestMethod()]
        public async Task GetAbiHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetAbiPostAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());

            var account = "eosio";
            var abi = await chainClient.GetAbiPostAsync(account);
        ...
        [TestMethod()]
        public async Task GetAccountGetAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());
        ...
        [TestMethod()]
        public async Task GetAccountHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetAccountPostAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());

            var accountName = "eosio";
            var account = await chainClient.GetAccountPostAsync(accountName);
        ...
        [TestMethod()]
        public async Task GetActivatedProtocolFeaturesGetAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());
        ...
        [TestMethod()]
        public async Task GetActivatedProtocolFeaturesHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetActivatedProtocolFeaturesPostAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());

            var activatedProtocolFeatures = await chainClient.GetActivatedProtocolFeaturesPostAsync();
        ...
        [TestMethod()]
        public async Task GetBlockGetAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());
        ...
        [TestMethod()]
        public async Task GetBlockHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetBlockPostAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());

            string blockNum = "100000000";
            var block = await chainClient.GetBlockPostAsync(blockNum);
        ...
        [TestMethod()]
        public async Task GetBlockHeaderStateGetAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());
        ...
        [TestMethod()]
        public async Task GetBlockHeaderStateHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetBlockHeaderStatePostAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());

            var info = await chainClient.GetInfoGetAsync();
            var blockHeaderState = await chainClient.GetBlockHeaderStatePostAsync(info.HeadBlockId);
        ...
        [TestMethod()]
        public async Task GetCodeGetAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());
        ...
        [TestMethod()]
        public async Task GetCodeHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetCodePostAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());
            var accountName = "kingcoolcorv";
            var code = await chainClient.GetCodePostAsync(accountName, true);
            ...
            accountName = "eosio";
            code = await chainClient.GetCodePostAsync(accountName, true);
            Assert.AreEqual(code.AccountName, accountName);
            Assert.AreEqual(code.CodeHash, "a7a10c302934b581a5a2f5193be8bdfc5c22fbd46fbdc49aeb14f0865e76a5d3");
            Assert.AreNotEqual(code.Wasm, "");
            Assert.AreEqual(code.Wast, "");
        ...
        [TestMethod()]
        public async Task GetCurrencyBalanceGetAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetCurrencyBalanceHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetCurrencyBalancePostAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetCurrencyStatsGetAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());
        ...
        [TestMethod()]
        public async Task GetCurrencyStatsHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetCurrencyStatsPostAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());
            var code = "eosio.token";
            var symbol = "WAX";
            var currencyStats = await chainClient.GetCurrencyStatsPostAsync(code, symbol);
            Assert.IsNotNull(currencyStats);
        }
        ...
        [TestMethod()]
        public async Task GetInfoHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetInfoPostAsyncTest()
        {
            var chainClient = new ChainClient(new HttpClient());
            var info = await chainClient.GetInfoPostAsync();
        ...
        {
            var chainClient = new ChainClient(new HttpClient());
            var info = await chainClient.GetProducersGetAsync();
        }

        [TestMethod()]
        public async Task GetProducersHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetProducersPostAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetRawAbiGetAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetRawAbiHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetRawAbiPostAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetRawCodeAndAbiGetAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetRawCodeAndAbiHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetRawCodeAndAbiPostAsyncTest()
        {
            Assert.Fail();
        }
        ...
        [TestMethod()]
        public async Task GetScheduledTransactionHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetScheduledTransactionPostAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetTableByScopeGetAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetTableByScopeHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetTableByScopePostAsyncTest()
        {
            Assert.Fail();
        }
        ...
        [TestMethod()]
        public async Task GetTableRowsHeadAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task GetTableRowsPostAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task PushTransactionAsyncTest()
        {
            Assert.Fail();
        }

        [TestMethod()]
        public async Task PushTransactionsAsyncTest()
        {
            Assert.Fail();
        }
        ...
        [TestMethod()]
        public async Task AbiBinToJsonHeadAsyncTest()
        {
        }

        [TestMethod()]
        public async Task AbiBinToJsonPostAsyncTest()
        {
        }
        ...
        [TestMethod()]
        public async Task AbiJsonToBinHeadAsyncTest()
        {
        }

        [TestMethod()]
        public async Task AbiJsonToBinPostAsyncTest()
        {
        }*/
